              ...
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex gap-3">
                  ...
                  <span>
                    ...
                    процесса разведки, создание базы данных, каркасных и блочных
                    моделей месторождений, разработка временных и постоянных ТЭО
                    кондиций и подсчет запасов, оперативный пересчет запасов в
                    процессе эксплуатации месторождения, сопровождение и
                    консультационные услуги в процессе разработки месторождений.
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
