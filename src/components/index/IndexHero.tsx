                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    <strong className="text-foreground">
                      Сопровождение разведки месторождений:
                    </strong>{" "}
                    разработка проектов геолого-разведочных работ, сопровождение
                    процесса разведки, включая создание базы данных и построение
                    каркасных и блочных моделей месторождений, разработка ТЭО
                    временных и постоянных разведочных кондиций и подсчет
                    запасов, оперативный пересчет запасов в процессе
                    эксплуатации месторождений, сопровождение и предоставление
                    консультационных услуг на всех этапах разработки.
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>
                    ...
                    включая геологические, топографические, экологические и
                    гидрометеорологические исследования. Наши услуги направлены
                    на обеспечение точного и качественного сбора данных для
                    проектирования и строительства объектов, а также на оценку
